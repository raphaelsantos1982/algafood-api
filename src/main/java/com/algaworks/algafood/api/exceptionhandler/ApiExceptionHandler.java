...
@ControllerAdvice // Ao adicionar essa anotação, pode adicionar ExceptionHandler(EH) que as excessoes de todos os controladores e todo o projeto serão tratadas aqui. Ponto central de tratamento de EH
public class ApiExceptionHandler extends ResponseEntityExceptionHandler {
		...
		@Override
		protected ResponseEntity<Object> handleTypeMismatch(TypeMismatchException ex, HttpHeaders headers, HttpStatus status, WebRequest request) { // Trata quando o tipo do parametro passado na url(@PathVariable) nao e o mesmo do tipo esperado
...
//				HttpStatus.NOT_FOUND, request);
	...
	// Deletado pq todos os handle... criados por mim  passaram a usar o handleExceptionInternal interno assim como os handle internos do spring mvc que estao na classe ResponseEntityExceptionHandler
//	@ExceptionHandler(EntidadeNaoEncontradaException.class) 
...
//	}
	...
	// Deletado pq a classe passou a extender ResponseEntityExceptionHandler, senao da erro de ambiguidade 
	...
	protected ResponseEntity<Object> handleExceptionInternal(Exception ex, Object body, HttpHeaders headers,
		...
		if (body == null) {
			body = Problem.builder()
				...
				.title(status.getReasonPhrase()) // status.getReasonPhrase() - Pequena descrição que "descreve" o status que esta sendo retornado
				.status(status.value())
				.userMessage(MSG_ERRO_GENERICA_USUARIO_FINAL)
				.build();
