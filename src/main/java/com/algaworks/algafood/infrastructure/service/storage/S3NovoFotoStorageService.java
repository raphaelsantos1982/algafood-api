...
public class S3NovoFotoStorageService implements FotoStorageService {

    @Autowired
    private StorageProperties storageProperties;

    @Autowired
    @Qualifier("amazonS3Novo") // Injeta o bean do AmazonS3 configurado para o S3 novo
    ...
    public void armazenar(NovaFoto novaFoto) {
        try {
            ...
            var putObjectRequest = new PutObjectRequest(
                    storageProperties.getS3Novo().getBucket(),
                    caminhoArquivo,
...
//                            CannedAccessControlList.PublicRead);
    ...
    private String getCaminhoArquivo(String nomeArquivo) {
        return String.format(
                "%s/%s",
                storageProperties.getS3Novo().getDiretorioFotos(),
                nomeArquivo);
    }
